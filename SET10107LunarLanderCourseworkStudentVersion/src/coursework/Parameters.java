...
public class Parameters {
	 ...
	 * 
	 */
	private static int numHidden = 17;	// combined to be halfed
	private static int numGenes = calculateNumGenes();
	public static double minGene = -1; // specifies minimum and maximum weight values 
	public static double maxGene = +1;
	public static int tournamentSize = 2; // lower the value the more variation and diverse population
	public static int popSize = 25;
	public static int maxEvaluations = 20000; // need to be 20000 when handed in
